...
- **Removing a project** keeps it under Settings → Recently removed for 30 days, with its deployments, actions and history, until you restore it or delete it for good.
