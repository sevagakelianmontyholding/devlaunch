  ...
  return (
    ...
    >
      <aside
        ...
        className="absolute inset-y-0 right-0 flex w-full max-w-[520px] flex-col border-l border-white/[0.08] bg-[#0d0e12]/98 shadow-[-30px_0_90px_rgba(0,0,0,0.42)]"
      >
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5">
          ...
          {repositoryUrl && (!runtime || runtime.repositories.length === 0) && (
            <section className="mt-6 rounded-xl border border-white/[0.065] bg-white/[0.02] p-4">
          ...
          {runtime?.docker.composeAvailable && (
            <section className="mt-6">
              ...
              <div className="mt-2 max-h-64 overflow-auto rounded-xl border border-white/[0.065] bg-black/35 p-3">
                {logsLoading && !logs ? (
        ...
        {confirmAction && (
          <div className="absolute inset-x-4 bottom-4 rounded-xl border border-amber-300/15 bg-[#191710]/95 p-4 shadow-[0_18px_60px_rgba(0,0,0,0.5)] backdrop-blur-xl">
        ...
        {confirmRemove && (
          <div className="absolute inset-x-4 bottom-4 rounded-xl border border-rose-300/15 bg-[#1b1114]/95 p-4 shadow-[0_18px_60px_rgba(0,0,0,0.5)] backdrop-blur-xl">
            <div className="flex gap-3">
