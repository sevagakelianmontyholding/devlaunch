      ...
      {confirming === "remove" && (
        <div className="mt-3 max-w-md">
          <Confirm
            ...
            body={
              <>
                It moves to Recently removed, at the bottom of the Projects page, for 30 days with its deployments, actions and history, and can be restored from there. The folder <span className="font-mono text-ink">{project.path}</span> is not touched.
              </>
            }
            confirmLabel="Remove"
            busy={busy === "remove"}
